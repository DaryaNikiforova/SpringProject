...
<t:flatTemplate pageHeader="Оформление билета">
    <jsp:body>
        <form:form role="form" class="form-horizontal" method="post" action="${pageContext.request.contextPath}/main/ticket/buy" modelAttribute="ticket">
            <div class="row">
                <div class="col-md-7">
                        ...
                        <div class="panel-body">
                            <div class="col-md-offset-3 col-md-10">
                                <!--c:forEach var="s" items="{ticket.getServices()}"-->
                                    ...
                                    <!--/div-->
                                <!--/c:forEach-->
                                <form:checkboxes path="services" items="${ticket.getServices()}" element='div class="checkbox"'/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
