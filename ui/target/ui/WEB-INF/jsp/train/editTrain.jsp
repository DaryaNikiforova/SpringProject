...
<t:flatTemplate menuBlock="train" menuRow="edit" pageHeader="Редактирование поезда">
    ...
    <jsp:body>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="well">
                    <form:form class="form-horizontal" action="${pageContext.request.contextPath}/main/train/edit/${train.number}" method="post" modelAttribute="train">
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <div class="col-lg-9"><form:label class="control-label" path="number">${train.number}</form:label></div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-3">Имя</label>
                                <div class="col-lg-9"><form:input path="name" type="text" class="form-control" maxlength="100" placeholder="Сапсан (не обязательно)" /></div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-3">Количество мест</label>
                                <div class="col-lg-9"><form:input path="seatCount" type="number" class="form-control" min="1" placeholder="100" maxlength="4" required="required" /></div>
                            </div>
                            <div class="form-group">
